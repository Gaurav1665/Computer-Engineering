...
class _SortListviewState extends State<SortListview> {
  ...
  Future<List<Map<String, dynamic>>> fetchData()async{
    ...
    return isAscSorted ? (data..sort()).toList() : (data..sort()).reversed.toList();
  }
    ...
    return Scaffold(
      appBar: AppBar(actions: [
        ...
        IconButton(
          ...
          icon: Icon( isAscSorted ?  Icons.arrow_downward_rounded : Icons.arrow_upward_rounded))
      ],),
      body: FutureBuilder(
        future: fetchData(),
