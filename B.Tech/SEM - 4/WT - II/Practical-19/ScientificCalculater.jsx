            ...
            <div className="container">
                <table className="table table-striped" style={{border: "5px solid black"}} >
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td scope="col"><button onClick={()=>setEquation(equation+"sin")}>sin</button></td>
                        ...
                        <tr>
                            <td scope="col"><button onClick={()=>setEquation(equation+"cos")}>cos</button></td>
                        ...
                        <tr>
                            <td scope="col"><button onClick={()=>setEquation(equation.slice(0, -1))}>C</button></td>
                        ...
                        <tr>
                            <td scope="col"><button onClick={()=>setEquation("")}>CA</button></td>
                            <td scope="col"><button onClick={()=>setEquation(equation+"00")}>00</button></td>
