...
import 'package:practicals/Lab-9/Practical-1%20&%202%20&%203/StudentModel.dart';
...
class _StudentAddState extends State<StudentAdd> {
  ...
  void initState() async{
    ...
    if(widget.id != null){
      StudentController sc = new StudentController();
      StudentModel student = sc.studentList.where((element) => element.id == widget.id,).first;
              ...
              onPressed: () {
                ...
                ? sc.addStudent(
                  student: StudentModel(
                    ...
                    rollNo: rollController!.text as int, 
                    enrollNo: enrollmentController!.text as int, 
                    sem: sem!
                  )
                ) 
                : sc.updateStudent(
